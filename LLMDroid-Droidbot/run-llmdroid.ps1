...
#Final Run for my TeatApp
#  cd D:\Nasir\LLMDroid\LLMDroid-v2\LLMDroid-Droidbot; ..\venv\Scripts\python.exe start.py -d emulator-5554 -a "D:\\Nasir\\LLMDroid\\LLMDroid-v2\\apks\\instrumented\\app-debug.apk" -o "D:\Nasir\LLMDroid\LLMDroid-v2\LLMDroid-Droidbot\results\TestAPP-restlu-5" -timeout 3600 -interval 3 -count 1000000 -keep_app -keep_env -policy dfs_greedy -grant_perm -cv